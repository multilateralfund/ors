# Generated by Django 4.2.17 on 2026-02-03 14:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="True if this is the lead agency for the project",
                    ),
                ),
                (
                    "is_unlocked",
                    models.BooleanField(
                        default=False,
                        help_text="MLFS can unlock submitted reports for corrections",
                    ),
                ),
                (
                    "funding_approved",
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="overall_assessment",
                        to="core.pcragencyreport",
                    ),
                ),
                (
        ...
        migrations.AddField(
            model_name="pcragencyreport",
            name="pcr",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                related_name="agency_reports",
                to="core.projectcompletionreport",
            ),
        ),
