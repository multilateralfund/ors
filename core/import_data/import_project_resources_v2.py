...
SUBSTANCE_FIELDS = [
    ...
    "Phase-out (CO2-eq tonnes)",
    "Phase-out (ODP tonnes)",
    "Phase-out (metric tonnes)",
    "Ods type",
    "Sort order",
]
...
FIELDS_WITH_ACTUAL_VALUES = [
    ...
    "Capacity-building programmes (e.g., end users, government entities, other stakeholders)",
...
def import_project_specific_fields(file_path):
    ...
    def _clean_up_field_name(field_name, mya=False):
        ...
        mya_clean_up = {
            ...
            "CCost effectiveness (US $/CO2-eq tonnes)": "Cost effectiveness (US$/ CO2-eq) (MYA)",
