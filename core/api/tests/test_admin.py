...
class TestAdminListingResponse:
    ...
    def test_get_200_on_admin_endpoints_listing(self, admin_user, setup_admin_listing):
        ...
        for url in urls:
            ...
            ), f"Failed to access {url} with status code {response.status_code}"
