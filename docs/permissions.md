...
| /api/projects/v2/{project_id}/project-files/<id>/download/            | GET    | has_project_v2_view_access               |  Entries filtered for `can_view_only_own_agency` and `can_view_production_projects`. |
