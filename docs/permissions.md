...
| projects/v2/{project_id}/project-files/                               | GET    | has_project_v2_view_access               | Entries filtered for `can_view_only_own_agency` and `can_view_production_projects`. `editable` field added for each file to point if the user can or cannot
| projects/v2/{project_id}/project-files/                               | POST   | has_project_v2_edit_access               | Entries filtered for `can_view_only_own_agency`and `can_view_production_projects`. Further filtering using `has_project_v2_draft_edit_access`, `has_project_v2_version1_version2_edit_access` and `has_project_v2_version3_edit_access`,`has_project_v2_edit_approved_access` (matches editable from GET)
| projects/v2/{project_id}/project-files/delete/                        | DELETE | has_project_v2_edit_access               |  Entries filtered for `can_view_only_own_agency` and `can_view_production_projects`. Further filtering using `has_project_v2_draft_edit_access`, `has_project_v2_version1_version2_edit_access` and `has_project_v2_version3_edit_access`, `has_project_v2_edit_approved_access` (matches editable from GET)
| projects/v2/{project_id}/project-files/include_previous_versions/     | GET    | has_project_v2_view_access               | Entries filtered for `can_view_only_own_agency` and `can_view_production_projects`. `editable` field added for each file to point if the user can or cannot delete the file |
| projects/v2/{project_id}/project-files/<id>/download/            | GET    | has_project_v2_view_access               |  Entries filtered for `can_view_only_own_agency` and `can_view_production_projects`. |
...
| projects/v2/{id}/delete                                                | DELETE  | has_project_v2_edit_access              | Entries filtered for `can_view_only_own_agency` and `can_view_production_projects`.  Further filtering only Draft, v1 projects.
| projects/v2/list_previous_tranches/country/<country_id>/cluster/<cluster_id>/tranche/<tranche>/           | GET    | has_project_v2_view_access               | Entries filtered for `can_view_only_own_agency` and `can_view_production_projects`. *only given project is filtered, all tranches are returned*
...
| projects/v2/{id}/remove_association/                                  | POST   | has_project_v2_remove_association_access | Entries filtered for `can_view_only_own_agency` and `can_view_production_projects`.
| projects/v2/{id}/disassociate_component/                              | POST   | has_project_v2_disassociate_component_access | Entries filtered for `can_view_only_own_agency` and `can_view_production_projects`.
