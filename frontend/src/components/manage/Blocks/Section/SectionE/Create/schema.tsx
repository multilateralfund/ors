    ...
    () => ({
      columnDefs: [
...

        {
          ...
          groupId: 'columns_shaded_in_grey_are_voluntary',
          headerGroupComponent: 'agColumnHeaderGroup',
          headerName: 'Columns shaded in grey are voluntary',
          marryChildren: true,
          ...sectionColGroupDefById['columns_shaded_in_grey_are_voluntary'],
        },
        {
          cellEditor: 'agNumberCellEditor',
          dataType: 'number',
