  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex gap-4">
        ...
        <Field
          name="search"
          FieldProps={{ className: 'mb-0 w-60 BPList' }}
        ...
        />
        {/* Rest of filters */}
        <div className="flex h-full flex-wrap items-center gap-x-4 gap-y-2 border-0 border-l border-solid border-gray-200 pl-4">
          <Field
