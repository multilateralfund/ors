  ...
  Toolbar: ({
    ...
    return (
      ...
      >
        ...
        <Portal active={!fullScreen} domNode="sectionToolbar">
          <div className="flex items-center justify-end">
            <Dropdown
              color="primary"
              tooltip="Download"
              label={
                <div className="flex justify-between items-center text-base gap-x-2">
                  <span className="text-primary font-medium">Download</span>
                  <IoDownloadOutline className="text-secondary text-xl"/>
                </div>
              }
              icon
            >
            ...
            {section.allowFullScreen && !fullScreen && (
              <Tooltip placement="top" title="Enter fullscreen">
                ...
                >
                  <div className="flex justify-between items-center text-base gap-x-2">
                    <span className="text-primary font-medium">Fullscreen</span>
                    <IoExpand className="text-secondary text-xl"/>
                  </div>
                </IconButton>
              </Tooltip>
            )}
            {fullScreen && (
              <Tooltip placement="top" title="Exit fullscreen">
                ...
                >
                  <div className="flex justify-between items-center text-base gap-x-2">
                    <span className="text-primary font-medium">Exit fullscreen</span>
                    <IoClose className="text-secondary text-xl"/>
                  </div>
                </IconButton>
              </Tooltip>
            )}
