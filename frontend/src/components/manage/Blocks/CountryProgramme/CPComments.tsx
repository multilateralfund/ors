    ...
    <form className="mt-4 flex w-full flex-col gap-4">
      ...
      <div className="flex w-full flex-1 flex-wrap gap-4">
        {labels.map((label) => (
          <div
            key={label}
            className="flex min-w-96 flex-grow flex-col rounded-lg bg-gray-100 p-2"
          >
            <label className="py-2 text-2xl font-normal">{label}</label>
            <div className="CPComments relative">
              ...
              />
              <div className="absolute bottom-2 right-2 flex gap-2 mb-2 opacity-50">
                <Button
                  color="primary"
