...
export const VersionsDropdown = ({
  ...
  return (
    <div className="relative">
      ...
      <div
        className={cx(
          'absolute left-0 z-10 max-h-[200px] origin-top overflow-y-auto rounded-none border border-solid border-primary bg-gray-A100 opacity-0 transition-all sm:left-auto sm:right-0 xl:left-0 xl:right-auto',
          {
