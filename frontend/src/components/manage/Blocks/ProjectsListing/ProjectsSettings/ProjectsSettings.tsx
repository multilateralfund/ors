...
const ProjectsSettingsListsOfTerms = () => (
  <mui.Box>
    ...
    <tr>
      <th className="py-2 pr-6">Label in application</th>
      <th className="px-6 py-2">Values</th>
    </tr>

    <tr>
      <td className="py-2 pr-6">Substances</td>
    ...
    <tr>
      <td className="py-2 pr-6">Substance alternative names</td>
      <td className="px-6 py-2">
        <a
          className="italic text-inherit"
          target="_blank"
    ...
    <p>
      The following fields do not have the values stored in the Master Database;
      the values are defined in the source code:
    </p>

    <tr>
      <th className="py-2 pr-10">Label in application</th>
      <th className="py-2 pr-10">Values</th>
    </tr>
    <tr>
    ...
    <tr>
      <td className="py-2 pr-10">Consumption level status</td>
      <td className="py-2 pr-10">
        LVC
        <br />
        Non-LVC
    ...
    <tr>
      <td className="py-2 pr-10">Production control type</td>
      <td className="py-2 pr-10">
        Reduction
        <br />
        Closure
    ...
    <tr>
      <td className="py-2 pr-10">Category</td>
      <td className="py-2 pr-10">
    ...
    <tr>
      <td className="py-2 pr-10">Attachments → Type</td>
      <td className="py-2 pr-10">
        Project proposal
        <br />
